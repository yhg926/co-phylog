...
int main(int argc, char* argv[])
{
	...
	if(argc!=3){
		printf("USAGE: ./fastaCovert2co <*.fasta.gz/*.fna.gz> <*.co> \n");
		exit(1);
	}

	gzFile infp; FILE *outfp;
	if( (infp=gzopen(argv[1],"r"))==NULL ){
